<?php
 ...
 ?>
	...
	<section class="container">
		<div class="conteudo" style="margin-left: 50px; margin-right: 50px;";>
			<div class="painel novidades painel-compacto" style="background-color: #fff;">
				<br>
				<blockquote>
				<p align="justify">
					A <strong>All Fashion</strong> é a maior empresa comércio eletrônico no segmento de moda em todo o mundo. Fundada há <?php print date("Y") - 1932 ?> anos,
					possui filiais em 124 países, sendo líder de mercado com mais de 90% de participação em 118 deles.
				</p>
			
				<p align="justify">
					Nosso centro de distribuição fica em Jacarezinho, no Paraná. De lá, saem 48 aviões que distribuem nossos produtos às casas
				...
				<p align="justify">
					...
					investiu todas as suas economias nessa nova iniciativa, revolucionária para a época. O fundador
				...
				<p align="justify">
					...
					brasileiros nas instalações de
					<a href="https://maps.google.com.br/?q=Jacarezinho">
						Jacarezinho no Paraná</a> e nos escritórios em todo país.
				</p>
